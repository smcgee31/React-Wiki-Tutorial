...
/***/ function(module, exports, __webpack_require__) {
	...
	var _WikipediaViewer = __webpack_require__(169);
	...
	(0, _reactDom.render)(_react2.default.createElement(_WikipediaViewer2.default, null), document.getElementById('wikipedia-viewer'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SearchForm = __webpack_require__(170);

	var _SearchForm2 = _interopRequireDefault(_SearchForm);

	var _ResultList = __webpack_require__(171);
	...
	var _superagentJsonp = __webpack_require__(179);
	...
	var WikipediaViewer = function (_React$Component) {
	  ...
	  function WikipediaViewer() {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(WikipediaViewer).call(this));
	  ...
	  _createClass(WikipediaViewer, [{
	    ...
	    value: function handleSearch(searchTerm) {
	      ...
	      _superagent2.default.get('https://en.wikipedia.org/w/api.php').query({
	        search: searchTerm,
	        action: 'opensearch',
	        format: 'json'
	      }).use(_superagentJsonp2.default).end(function (error, response) {
	        if (error) {
	          console.error(error);
	        } else {
	...
	var SearchForm = function (_React$Component) {
	  ...
	  _createClass(SearchForm, [{
	    ...
	    value: function handleSubmit(event) {
	      event.preventDefault();
	      var searchTerm = this.state.searchTerm.trim(); // trim removes whitespace and the beginning and end

	      if (!searchTerm) {
	        // If no search term was typed, return early and do nothing
	        return;
	      }
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('input', { className: 'search-box-text', type: 'text', placeholder: 'Search for something...', onChange: this.handleInputChange.bind(this), value: this.state.searchTerm })
	        ),
	        _react2.default.createElement(
	          'p',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SingleResult = __webpack_require__(172);
	  ...
	  _createClass(ResultList, [{
	    ...
	    value: function render() {
	      ...
	      var results = this.props.results[1].map(function (result, index) {
	        return _react2.default.createElement(_SingleResult2.default, { key: index, title: _this2.props.results[1][index], description: _this2.props.results[2][index], url: _this2.props.results[3][index] });
	      });
	      return _react2.default.createElement(
	        'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SingleResult = function (_React$Component) {
	  ...
	  function SingleResult() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(SingleResult).apply(this, arguments));
	  }
